...
// nationality
const nationalitySchema = yup.string().required('requiredError').typeError('typeError');
...
// religion job post
const religionSchema = yup.string().required('requiredError').typeError('typeError');
...
const startingDateSchema = yup.string().required('requiredError').typeError('typeError');
