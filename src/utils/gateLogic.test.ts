...
describe("isLogicGateId", () => {
  it("accepts known gate ids", () => {
    expect(isLogicGateId("and")).toBe(true);
    expect(isLogicGateId("xor")).toBe(true);
    expect(isLogicGateId("not")).toBe(true);
  });

  it("rejects unknown values", () => {
    expect(isLogicGateId("invalid")).toBe(false);
    expect(isLogicGateId("AND")).toBe(false);
    expect(isLogicGateId("")).toBe(false);
  });
});
